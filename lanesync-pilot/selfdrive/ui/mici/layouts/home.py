...
class MiciHomeLayout(Widget):
  def __init__(self):
    ...
    self._openpilot_label = UnifiedLabel("LaneSync", font_size=96, font_weight=FontWeight.DISPLAY, max_width=480, wrap_text=False)
  ...
  def _get_version_text(self) -> tuple[str, str, str, str] | None:
    lanesync_version = ui_state.params.get("LaneSyncVersion")
    ...
    if lanesync_version:
      version = f"{lanesync_version} · {version}"
