...
from openpilot.selfdrive.ui.onroad.phone_nav_indicator import draw_phone_nav_banner
from openpilot.selfdrive.ui.onroad.v2i_network_indicator import draw_v2i_network_badge
from openpilot.selfdrive.ui.onroad.v2i_indicator import draw_v2i_hazard_badge, draw_v2i_indicator
...
class HudRenderer(Widget):
  ...
  def _render(self, rect: rl.Rectangle) -> None:
    ...
    draw_v2i_indicator(rect.x + 24, rect.y + 24)
    draw_v2i_hazard_badge(rect.x + rect.width / 2 - 90, rect.y + 8)
    draw_phone_nav_banner(rect.x + rect.width / 2 - 200, rect.y + 8, max_width=400)
    draw_v2i_network_badge(rect.x + rect.width - 240, rect.y + 8)
