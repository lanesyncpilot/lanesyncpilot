...
<h1>LaneSync Pilot</h1>

<p>
  <b>LaneSync Pilot is an openpilot fork with V2I and Navigation built in.</b>
  <br>
  Vehicle-to-Infrastructure signals, iPhone/CarPlay navigation, and connected driving — on 300+ supported cars.
</p>

<p>
  <a href="docs/LANESYNC.md">LaneSync docs</a>
  <span> · </span>
  Based on <a href="https://github.com/commaai/openpilot">openpilot v0.11.0</a>
  <span> · </span>
  LaneSync <strong>v1.0.0</strong>
</p>
