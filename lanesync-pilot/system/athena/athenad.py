...
def getVersion() -> dict[str, str]:
  from openpilot.common.lanesync_version import LANESYNC_NAME, LANESYNC_VERSION
  build_metadata = get_build_metadata()
  params = Params()
  return {
    "version": build_metadata.openpilot.version,
    "lanesync_version": params.get("LaneSyncVersion") or LANESYNC_VERSION,
    "lanesync_name": LANESYNC_NAME,
